...
- [x] Purchase-order draft creation, order register, detail view, and inventory receiving workflow.
...
- [ ] Warehouse/location edit, archive, and validation feedback workflows.
